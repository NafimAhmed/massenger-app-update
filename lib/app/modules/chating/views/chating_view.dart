...
import 'package:massenger_app3/app/utils/widget/custom_app_bar.dart';
import 'package:massenger_app3/app/utils/widget/customaction.dart';
...
class ChatingView extends GetView<ChatingController> {
  ...
  Widget build(BuildContext context) {
   return Scaffold(
      appBar:  buildCustomAppBar(context), // Use the imported custom AppBar
      ...
      body: Column(
        children: [
          ...
          // _buildInputField(),
          ActionButtonsWidget(),  // Method for action buttons
        ],
      ),
    );
  }
