              ...
              appBar: AppBar(
                ...
                leading: Padding(
                  ...
                  child: InkWell(
                    ...
                    child: CircleAvatar(
                      ...
                      radius: 20
                          .r, // Responsive avatar size using flutter_screenutil
                    ),
                  ),
                ),
                title: Row(
                    ...
                    GestureDetector(
                      onTapDown: (TapDownDetails details) {
                        _showPopupMenu(
                            context,
                            details
                                .globalPosition); // Call to open the custom menu
                      },
                      child: Icon(
                ...
                actions: [
                  IconButton(
                    onPressed: () {
                      controller
                          .toggleMultiSelect(); // Toggle state using controller
                    },
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          prefixIcon: Icon(Icons.search,
                              size: 24.sp, color: Colors.grey), // Search icon
        ...
        children: [
          Row(
            children: [
              ...
              Text('(0)',
                  style: TextStyle(
                      color: Colors.black)), // Dynamic selection count
            ],
          ),
          Row(
            children: [
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            SizedBox(
                width: 12.w), // Responsive space between avatar and content
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Container(
                        padding: EdgeInsets.symmetric(
                            horizontal: 4.w, vertical: 2.h), // Badge padding
                        decoration: BoxDecoration(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          fontSize: 12.sp,
                          color:
                              Colors.grey[600], // Grey color for last message
                        ),
                ...
                Row(
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: Colors.green[
                            100], // Background color for the status badge
                        borderRadius: BorderRadius.circular(12.r),
                      ),
                      child: Text(
                    ...
                    Text(
                      time,
                      style: TextStyle(
                          color: Colors.grey, fontSize: 12.sp), // Time text
                    ),
                  ],
                ),
                Row(
